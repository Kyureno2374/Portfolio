...
const PROJECTS: Project[] = [
  ...
  },
  {
    id: '5',
    title: 'Cvrsxd World',
    description: 'Discord бот для сервера zxcursed с расширенным функционалом модерации, экономики и развлекательными командами.',
    mainCategory: 'External Projects',
    subCategory: 'Backend',
    technologies: ['TypeScript 100%'],
    discord: 'https://discord.gg/zxcursed',
    discordName: 'zxcursed',
    githubPlaceholder: 'https://github.com/Kyurenoxd/cvrsxd-world',
    details: {
      overview: 'Многофункциональный Discord бот для сервера zxcursed, разрабатываемый на TypeScript',
      features: [
        'Система модерации',
        'Система экономики',
