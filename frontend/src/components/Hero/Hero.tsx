      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
          <div className="relative z-10 text-center">
            ...
            >
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-9xl font-bold mb-2 
                bg-gradient-to-r from-[#262626] via-[#E5E5E5] to-[#262626] 
                bg-clip-text text-transparent 
                drop-shadow-[0_0_30px_rgba(229,229,229,0.3)]
                animate-gradient-x
                bg-[length:200%_auto]
                whitespace-nowrap"
              >
              ...
              >
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-exo mb-6
                  bg-gradient-to-r from-[#262626] via-[#A0A0A0] to-[#262626]
                  bg-clip-text text-transparent
                  animate-gradient-x
                  bg-[length:200%_auto]
                  tracking-wider"
